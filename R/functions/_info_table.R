...
info_table <- function(r, data, var_type, var_left, var_right, df, select_id,
  ...
  if (var_type %in% c("NA_delta", "NA_delta_bivar")) {
    ...
    return(HTML(curbcut::cc_t(lang = r$lang(), translation = translation, out)))}
  ...
  # ALL NA
  if (var_right[1] != " " && z$var_type == "all_na") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
  ...
  if (z$var_type == "kah_na") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
  ...
  if (z$var_type == "kan_na") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
  ...
  if (z$var_type == "uni_na") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
    "{z$place_name} has no data available on {z$exp_left}.")
  
  # Bivariate, NA selection
  if (grepl("^bi_na", z$var_type)) out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
    "{z$place_name} has no data available on {z$exp_left} and ",
    "{z$exp_right}.")
  
  # Univariate multi-date, NA selection
  if (z$var_type == "uni_na_delta") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
  ...
  if (z$var_type == "uni_quant_all") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
  ...
  if (z$var_type == "uni_quant_select") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
  ...
  if (z$var_type == "uni_qual_all") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
    "At the {z$scale_sing} scale, {z$exp_left} varies from ",
  ...
  if (z$var_type == "uni_qual_select") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
    "<strong>{z$place_heading}</strong>",
    "<p>{z$place_name} has a population of {z$pop} and a ",
  ...
  # Univariate, quantitative, no selection
  if (z$var_type == "uni_quant_all_delta") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
  ...
  if (z$var_type == "uni_quant_select_delta") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
    "<strong>{z$place_heading}</strong>",
  ...
  # Univariate, qualitative, no selection
  if (z$var_type == "uni_qual_all_delta") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
  ...
  # Univariate, qualitative, valid selection
  if (z$var_type == "uni_qual_select_delta") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
    "<strong>{z$place_heading}</strong>",
  ...
  if (z$var_type == "bi_quantxy_all") {
    ...
    if (z$correlation < 0.05 && z$correlation > -0.05) {
      out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
      ...
      out <- paste0(
        if (z$strong == curbcut::cc_t(lang = r$lang(), translation = translation, "strong")) 
          curbcut::cc_t(lang = r$lang(), translation = translation, "<p><b>STRONG CORRELATION</b></p>"),
        curbcut::cc_t(lang = r$lang(), translation = translation, "<p>'{z$title_left}' has a {z$strong} {z$pos} ",
  ...
  if (z$var_type == "bi_quantxy_select") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
    "<strong>{z$place_heading}</strong>",
  ...
  if (z$var_type == "bi_quanty_all") {
    ...
    if (z$correlation < 0.05 && z$correlation > -0.05) {
      ...
      out <- paste0(
        if (z$strong == curbcut::cc_t(lang = r$lang(), translation = translation, "strong")) 
          curbcut::cc_t(lang = r$lang(), translation = translation, "<p><b>STRONG CORRELATION</b></p>"),
        curbcut::cc_t(lang = r$lang(), translation = translation, "<p>'{z$title_left}' has a {z$strong} {z$pos} correlation ",
  ...
  if (z$var_type == "bi_quanty_select") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
    "<strong>{z$place_heading}</strong>",
    "<p>{z$place_name} has a population of {z$pop}, ",
  ...
  if (z$var_type == "bi_quantx_select") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
    "<strong>{z$place_heading}</strong>",
    "<p>{z$place_name} has a population of {z$pop}, ",
    "a {z$title_left} value of '{z$val_left}', and a ",
    "'{z$title_right}' value of '{z$val_right}'. ",
  ...
  if (z$var_type == "bi_quantxy_all_delta") {
    ...
    if (abs(z$correlation) < 0.05) {
      ...
      out <- paste0(
        if (z$strong == curbcut::cc_t(lang = r$lang(), translation = translation, "strong")) 
          curbcut::cc_t(lang = r$lang(), translation = translation, "<p><b>STRONG CORRELATION</b></p>"),
        curbcut::cc_t(lang = r$lang(), translation = translation, "<p>From {z$start_date_left} to {z$end_date_left}, the change in ", 
  ...
  # Bivariate, quantitative, valid selection
  if (z$var_type == "bi_quantxy_select_delta") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
    "<strong>{z$place_heading}</strong>",
  ...
  # Bivariate, qualitative x, quantitative y, valid selection
  if (z$var_type == "bi_quanty_select_delta") out <- curbcut::cc_t(lang = r$lang(), translation = translation, 
    "<strong>{z$place_heading}</strong>",
  ...
  if (date_left == date_right && nchar(date_left) == 4 &&
    ...
    out <- paste(out, curbcut::cc_t(lang = r$lang(), translation = translation, "<i>(Data from {date_left}.)</i>"))
  }
  if (date_left != date_right && nchar(date_left) == 4 &&
      !grepl("_na", z$var_type)) {
    out <- paste(out, curbcut::cc_t(lang = r$lang(), translation = translation, 
