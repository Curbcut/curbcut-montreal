  ...
  if (var_left == "c_priority") {
    ...
    HTML(sus_translate(
      ...
      "provided by natural infrastructure in the region.</p>"))
                             ...
                             "c_bio")) {
    c_bio <- paste0(
      "<li><i>", sus_translate(variables$var_title[variables$var_code == 'c_bio']), ":</i> ", 
      sus_translate(variables$explanation[variables$var_code == 'c_bio']))
    habitat_qual <- paste0(
      "<li><i>", sus_translate(variables$var_title[variables$var_code == 'habitat_qual']), 
      ":</i> ", sus_translate(variables$explanation[variables$var_code == 'habitat_qual']))
    habitat_con <- paste0(
      "<li><i>", sus_translate(variables$var_title[variables$var_code == 'habitat_con']), 
      ":</i> ", sus_translate(variables$explanation[variables$var_code == 'habitat_con']))
    favorable_cc <- paste0(
      "<li><i>", sus_translate(variables$var_title[variables$var_code == 'favorable_cc']), 
      ":</i> ", sus_translate(variables$explanation[variables$var_code == 'favorable_cc']))
    ...
    c_flood <- paste0(
      "<li><i>", sus_translate(variables$var_title[variables$var_code == 'c_flood']), ":</i> ", 
      sus_translate(variables$explanation[variables$var_code == 'c_flood']))
    flood <- paste0(
      "<li><i>", sus_translate(variables$var_title[variables$var_code == 'flood']), ":</i> ", 
      sus_translate(variables$explanation[variables$var_code == 'flood']))
    ...
    c_heat <- paste0(
      "<li><i>", sus_translate(variables$var_title[variables$var_code == 'c_heat']), ":</i> ", 
      sus_translate(variables$explanation[variables$var_code == 'c_heat']))
    heat <- paste0(
      "<li><i>", sus_translate(variables$var_title[variables$var_code == 'heat']), ":</i> ", 
      sus_translate(variables$explanation[variables$var_code == 'heat']))
    cool <- paste0(
      "<li><i>", sus_translate(variables$var_title[variables$var_code == 'cool']), ":</i> ", 
      sus_translate(variables$explanation[variables$var_code == 'cool']))
