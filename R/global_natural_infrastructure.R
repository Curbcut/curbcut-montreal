...
vars_natural_infrastructure_left_ni_contribution_biodiversity_conservation <- 
  list("----" = " ",
...
vars_natural_infrastructure_left_ni_contribution_flood_prevention <- 
  list("----" = " ",
       "Flood risk areas" = "flood_risks")

vars_natural_infrastructure_left_ni_contribution_heat_island_reduction <- 
  list("----" = " ",
...
natural_infrastructure_explanations <-
