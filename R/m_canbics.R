...
# # GLOBAL ------------------------------------------------------------------
# 
# `canbics_default_region` <- unlist(modules$regions[modules$id == "canbics"])[1]
# `canbics_mzp` <-
#   eval(parse(text = paste0("map_zoom_levels_", `canbics_default_region`)))
# default_region <- modules$regions[modules$id == "canbics"][[1]][1]
# 
# # UI ----------------------------------------------------------------------
# 
# `canbics_UI` <- function(id) {
#   shiny::tagList(
#     # Sidebar
#     curbcut::sidebar_UI(
#       id = shiny::NS(id, id),
...
#         curbcut::zoom_UI(shiny::NS(id, id), `canbics_mzp`)
#       )
#     ),
# 
#     # Map
...
# 
#     # Left variable
#     var_left <- reactive(paste("canbics", time(), sep = "_"))
# 
