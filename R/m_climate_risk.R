...
climate_risk_UI <- function(id) {
  ...
  #       curbcut::picker_UI(NS(id, id), var_list = dropdown_make(
...
climate_risk_server <- function(id, r) {
  ...
  # 
  #   # Initial reactives
  #   zoom_string <- reactiveVal(zoom_get_string(map_zoom, map_zoom_levels_island,
  #                                              "CSD"))
  ...
  #                       r = r,
  #                       var_list = reactive(
  #                         dropdown_make(only = list(theme = "Climate risk"))))
  # 
