    ...
    sidebar_UI(
      ...
      susSidebarWidgets(
        select_var_UI(NS(id, id), 
                      ...
                      label = curbcut::cc_t(translation = translation, "Theme")),
        select_var_UI(NS(id, id), 
                      select_var_id = "d_2",
                      var_list = list("----" = " "),
                      label = curbcut::cc_t(translation = translation, "Indicator")),
        slider_UI(NS(id, id),
                  label = curbcut::cc_t(translation = translation, "Amount of territory to protect"),
                  min = 0,
                  max = 25,
                  step = 1,
                  value = 17,
        ...
        checkbox_UI(NS(id, id),
                    label = curbcut::cc_t(translation = translation, "Custom priorities")),
        slider_text_UI(NS(id, id),
                       slider_id = "s_bio",
                       label = curbcut::cc_t(translation = translation, "Biodiversity conservation"),
                       choices = custom_slider_choices,
                       selected = "Important"),
        slider_text_UI(NS(id, id),
                       slider_id = "s_hea",
                       label = curbcut::cc_t(translation = translation, "Heat island reduction"),
                       choices = custom_slider_choices,
                       selected = "Important"),
        slider_text_UI(NS(id, id),
                       slider_id = "s_flo",
                       label = curbcut::cc_t(translation = translation, "Flood prevention"),
                       choices = custom_slider_choices,
                       selected = "Important")
        ),
