...
vac_rate_UI <- function(id) {
  ...
  #       curbcut::picker_UI(NS(id, id), picker_id = "d1",
  #                     var_list = var_left_list_1_vac_rate,
  #                     label = curbcut::cc_t("Vacancy rate distribution")),
  #       curbcut::picker_UI(NS(id, id), picker_id = "d2",
  #                     var_list = var_left_list_2_vac_rate,
  #                     label = curbcut::cc_t("Bedroom type")),
  #       curbcut::picker_UI(NS(id, id), picker_id = "d3",
  #                     var_list = var_left_list_3_vac_rate,
  #                     label = curbcut::cc_t("Year of construction")),
  #       curbcut::picker_UI(NS(id, id), picker_id = "d4",
  #                     var_list = var_left_list_4_vac_rate,
  #                     label = curbcut::cc_t("Rent ranges")),
  #       slider_UI(NS(id, id), slider_id = "slu",
  #                 min = 2010, max = 2021, step = 1, value = 2021),
  #       slider_UI(NS(id, id), slider_id = "slb",
  #                 label = curbcut::cc_t("Select two years"),
  #                 value = c("2011", "2020"),
  #                 min = 2010, max = 2021, step = 1),
  #       checkbox_UI(NS(id, id),
  #                   label = curbcut::cc_t("Compare dates")),
...
vac_rate_server <- function(id, r) {
  ...
  #   observeEvent(gr(), {
  #     toggle(paste0(id, "-d2"), condition = gr() == "bed")
  #     toggle(paste0(id, "-d3"), condition = gr() == "year")
  #     toggle(paste0(id, "-d4"), condition = gr() == "rent_range")
  #   })
  # 
