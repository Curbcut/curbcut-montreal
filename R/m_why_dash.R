...
why_dash_UI <- function(id) {
  ...
  tagList(
    ...
    susPage(class="sus-page-about", footer = susFooter(),susPageSection(
      h2(paste0("Why a dashboard? The science behind SUS")),
      img(src = "glamour_shot.png", height = 300),
      p(paste0("Urban sustainability is a complex, multidimensional ",
      ...
      p(paste0("Dashboards offer a tool for communicating ",
                      ...
                      "Pettit et al. 2012).")),
      p(paste0("SUS - a comprehensive and inclusive urban ",
      ...
      p(paste0("SUS stands at the intersection of two ongoing ",
                      ...
                      "Mattern 2015).")),
      p(paste0("SUS relies on a unified data infrastructure to help ",
                      ...
                      "making.")),
      p(paste0("While the primary implementation of SUS is focused on ",
      ...
      p(paste0("SUS mobilizes quantitative data and analysis and ",
      ...
      p(paste0("SUS catalyzes new understandings of urban ",
