...
why_dash_UI <- function(id) {
  ...
  tagList(
    ...
    fixedPage(
      ...
      p(sus_translate(paste0("Urban sustainability is a complex, multidimensional ",
                      ...
                      "living."))),
      p(sus_translate(paste0("Dashboards offer a tool for communicating ",
                      ...
                      "Pettit et al. 2012)."))),
      p(sus_translate(paste0("SUS - a comprehensive and inclusive urban ",
      ...
      p(sus_translate(paste0("SUS stands at the intersection of two ongoing ",
                      ...
                      "Mattern 2015)."))),
      p(sus_translate(paste0("SUS relies on a unified data infrastructure to help ",
                      ...
                      "making."))),
      p(sus_translate(paste0("While the primary implementation of SUS is focused on ",
      ...
      p(sus_translate(paste0("SUS mobilizes quantitative data and analysis and ",
      ...
      p(sus_translate(paste0("SUS catalyzes new understandings of urban ",
