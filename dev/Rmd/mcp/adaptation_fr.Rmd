...
```{r, echo=FALSE, fig.align = 'center', out.width="75%", fig.cap="Les îlots de chaleur représentent l'un des plus importants défis d'adaptation auxquels Montréal devra faire face."}
