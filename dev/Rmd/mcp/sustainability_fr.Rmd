...
knitr::include_graphics(here("www","/mcp","/visuals","/sustainability","/emissions_sector.png"))
...
```{r, echo=FALSE, fig.align = 'center', warning=FALSE, out.width="80%"}
knitr::include_graphics(here("www","/mcp","/visuals","/sustainability","/emissions_source.png"))
