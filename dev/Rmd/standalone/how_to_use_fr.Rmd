...
```
maximum, le minimum, la médiane et les intervalles interquantiles. Les <b>diagrammes de dispersion</b> sont utiles pour visualiser la relation entre deux variables continues. Dans Sus, une couleur est généralement attribuée à chaque point du nuage de points, ce qui fournit un troisième niveau d'analyse.
