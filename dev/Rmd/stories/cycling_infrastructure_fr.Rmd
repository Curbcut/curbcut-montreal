---
title: "Histoire de l'infrastructure cyclable à Montréal"
author: "Philip Bligh"
date: "07.2022"
...
lines <- 
  lines |> # bind_rows(lines, lines_2022)  |>  
  st_transform(4326) |> 
  # select(-ID) |> 
...
```{r, echo=FALSE}
bscols(map)
y <- crosstalk::filter_select("cycl_date", "Sélectionnez une année", key, ~date, multiple = FALSE)
bscols(y)
```
...
```{r echo=FALSE, fig.height=1, fig.align='center'}
  type_fill <- 
    data.frame(type = c("Nouvelle piste cyclable", "Piste retirée", 
