...
shiny::fluidPage(
  ...
  shiny::fluidRow(
    shiny::column(width = 12, align = "center", 
      shinyWidgets::sliderTextInput(inputId = "year", label = "Sélectionner l'année:", 
...
cycling_infrastructure_legend <- function(year, ...) {
  ...
  types_df <- 
    data.frame(year = c(1986, 1991, 1996, 2001, 2006, 2011, 2016, 2022),
               types = I(list(c("Piste cyclable"), 
                              c("Nouvelle piste cyclable", "Piste retirée", "Ancienne piste cyclable"),
                              c("Nouvelle piste cyclable", "Piste retirée", "Ancienne piste cyclable"),
                              c("Nouvelle piste cyclable", "Piste retirée", "Ancienne piste cyclable"),
                              c("Nouvelle piste cyclable", "Piste retirée", "Ancienne piste cyclable"),
                              c("Nouvelle piste cyclable", "Piste retirée", "Ancienne piste cyclable"),
                              c("Nouvelle piste cyclable", "Piste retirée", "Ancienne piste cyclable", "Station Bixi"),
                              c("Piste cyclable", "Station Bixi"))))
  
  types <- 
    unlist(types_df$types[types_df$year == year])
  
  type_fill <- 
    data.frame(type = c("Piste cyclable", "Nouvelle piste cyclable", "Piste retirée", 
                        "Ancienne piste cyclable", "Station Bixi"),
...
output$stories_custom_legend <- shiny::renderPlot({
  cycling_infrastructure_legend(input$year)
})
