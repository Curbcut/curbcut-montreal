...
src="https://youtu.be/pLKHlLj4q7c" frameborder="0" allowfullscreen="" data-external="1">
</iframe>
</div>
</center>
...
metro_evolution <- metro_evolution |> 
...
```{r, echo=FALSE}
bscols(map)
y <- crosstalk::filter_select("metro_date", "Select year", metro_evolution, ~date, multiple = FALSE)
bscols(y)
```
