...
```{r, echo=FALSE}
metro1910 <- read_sf(here("dev/data/stories/shp/metro_evolution/metro_1910_plan.shp"))
metro1944 <- read_sf(here("dev/data/stories/shp/metro_evolution/metro_1944_plan.shp"))
metro1953 <- read_sf(here("dev/data/stories/shp/metro_evolution/metro_1953.shp"))
metro1961 <- read_sf(here("dev/data/stories/shp/metro_evolution/metro_1961.shp"))
metro1967 <- read_sf(here("dev/data/stories/shp/metro_evolution/metro_1967.shp"))
metro1978 <- read_sf(here("dev/data/stories/shp/metro_evolution/metro_1978.shp"))
metro1981 <- read_sf(here("dev/data/stories/shp/metro_evolution/metro_1981_plan.shp"))
metro1970s <- read_sf(here("dev/data/stories/shp/metro_evolution/metro_1970s.shp"))
metro2000s <- read_sf(here("dev/data/stories/shp/metro_evolution/metro_plans_2000s.shp"))
```
...
names(metro1910)[1] <- "Legend"
tmap_mode("view")
m <- tm_shape(metro1910)+
  tm_lines("Legend", palette = c(`Proposed extension` = "#1263a6", `Proposed line` = "black"), 
           lwd = 5)
tmap_leaflet(m)
```
...
```{r, echo=FALSE, message=FALSE}
names(metro1944)[1] <- "Legend"
tmap_mode("view")
l <- tm_shape(metro1944)+
  tm_lines("Legend", palette = c(`Proposed extension` = "#1263a6", `Proposed line` = "black"),
           lwd = 3)
tmap_leaflet(l)
```
...
```{r, echo=FALSE, message=FALSE}
names(metro1953)[1] <- "Legend"
o <- tm_shape(metro1953)+
  tm_lines("Legend", palette = "black", lwd = 3)
tmap_leaflet(o)
```
...
```{r, echo=FALSE, message=FALSE}
names(metro1961)[1] <- "Legend"
p <- tm_shape(metro1961)+
  tm_lines("Legend", palette = c(`Proposed extensions` = "#1263a6", 
                               `Proposed orange and green lines` = "black", 
                               `Proposed red line` = "red"),
           lwd = 3)
tmap_leaflet(p)
```
...
```{r, echo=FALSE, message=FALSE}
names(metro1967)[1] <- "Legend"
q <- tm_shape(metro1967)+
  tm_lines("Legend", palette = c(`Green line` = "#00A650", `Orange line` = "#F47216", `Yellow line` = "#FCD300"),
           lwd = 3)
tmap_leaflet(q)
```
...
```{r, echo=FALSE, message=FALSE}
names(metro1981)[1] <- "Legend"
r <- tm_shape(metro1981)+
  tm_lines("Legend", palette = c(`Orange line` = "#F47216",
                               `Green line` = "#00A650",
                               `Yellow line` = "#FCD300",
                               `Proposed orange line extension` = "#f5d7a4",
                               `Proposed green line extension` = "#76c274",
                               `Proposed blue line` = "#9cc0f0"),
           lwd = 3)
tmap_leaflet(r)
```
...
```{r, echo=FALSE, message=FALSE}
names(metro1978)[1] <- "Legend"
s <- tm_shape(metro1978)+
  tm_lines("Legend", palette = c(`Green line` = "#00A650",
                               `Orange line` = "#F47216",
                               `Yellow line` = "#FCD300"),
           lwd = 3)
tmap_leaflet(s)
...
```{r, echo=FALSE, message=FALSE}
names(metro1970s)[1] <- "Legend"
n <- tm_shape(metro1970s)+
  tm_lines("Legend", palette = c(`Blue line` = "#1082CD", 
                               `Orange line` = "#F47216",
                               `Green line` = "#00A650",
                               `Yellow line` = "#FCD300",
                               `Proposed orange line extension` = "#f5d7a4",
                               `Proposed blue line extension` = "#9cc0f0",
                               `Proposed line 10` = "black",
                               `Proposed line 11` = "#454545",
                               `Proposed line 6` = "#696868",
                               `Proposed line 7` = "#949292",
                               `Proposed line 8` = "#b5b1b1"),
           lwd = 3)
tmap_leaflet(n)
```
...
```{r, echo=FALSE, message=FALSE}
names(metro2000s)[1] <- "Legend"
t <- tm_shape(metro2000s)+
  tm_lines("Legend", palette = c(`Orange line` = "#F47216",
                               `Blue line` = "#1082CD",
                               `Green line` = "#00A650",
                               `Yellow line` = "#FCD300",
                               `Proposed orange line extension` = "#f5d7a4",
                               `Blue line extension` = "#9cc0f0",
                               `Proposed yellow line extension` = "#faf093",
                               `Proposed pink line` = "#E60E70"),
           lwd = 3)
tmap_leaflet(t)
```
