...
```{r, echo = FALSE}
bscols(map)
y <- crosstalk::filter_select("metro_date", "Select year", nc, ~date, multiple = FALSE)
bscols(y)
```
...
```{r, echo = FALSE}
  ...
  # 
  # values <-
  #   metro_evolution[metro_evolution$date == date, ][[paste0("type_", "en")]] |>
  #   unique()
  # 
  # legend <-
