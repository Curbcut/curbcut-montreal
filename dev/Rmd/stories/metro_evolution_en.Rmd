...
knitr::include_graphics(here::here("www/stories/visuals/metro_evolution/modern_day_metro.jpeg"))
...
knitr::include_graphics(here::here("www/stories/visuals/metro_evolution/jean_drapeau.jpeg"))
...
knitr::include_graphics(here::here("www/stories/visuals/metro_evolution/drapeau_proposal.jpeg"))
```
...
knitr::include_graphics(here::here("www/stories/visuals/metro_evolution/MetroMontreal_FuturPasse.png"))
```
...
knitr::include_graphics(here::here("www/stories/visuals/metro_evolution/REM_Carte_reseauMtl_EN.jpeg"))
```
  ...
  shiny::fluidRow(
    shiny::column(width = 12, align = "center", 
      shinyWidgets::sliderTextInput(inputId = "year", label = "Select year:", 
            choices = c(1910, 1944, 1953, 1961, 1967, 1970, 1978, 1981, 2000), selected = 2000)
    )
  ),
  shiny::fluidRow(
     shiny::column(width = 12, align = "center", 
...
shiny::observeEvent(input$year, {
  rdeck::rdeck_proxy("stories_custom_map") |> 
    rdeck::add_mvt_layer(
        ...
        data = rdeck::tile_json("sus-mcgill.stories-metro_evolution"),
        visible = TRUE,
        get_line_width = 5,
...
output$stories_custom_legend <- shiny::renderPlot({
  metro_evolution_legend(input$year, lang = "en")
})
