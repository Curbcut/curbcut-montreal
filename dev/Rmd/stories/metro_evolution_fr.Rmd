...
legend <- 
  data.frame(x = seq_along(values),
             y = 1,
             fill = 
               unique(metro_evolution[metro_evolution$type_fr %in% values, ]$fill))
...
ggsave(plot = out,
       filename = here(paste0("www/stories/visuals/metro_evolution/legend_", date, "_fr.png")),
       units = "px",
       height = ceiling(nrow(legend) / 4) * 200)

knitr::include_graphics(here(paste0("www/stories/visuals/metro_evolution/legend_", date, "_fr.png")))
