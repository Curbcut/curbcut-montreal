...
add_row_trans <- function(data, var_code, vec_2016, vec_2011, vec_2006, vec_2001,
...
census_transport <-
  ...
  add_row_trans(
    ...
    vec_1996 = c("v_CA1996_1326", "v_CA1996_1327", "v_CA1996_1335", "v_CA1996_1336"),
    var_title = "Drive to work (%)",
    var_short = "TKTK",
    explanation = "the percentage of people who drive a privately owned car or truck to work",
    private = FALSE
  ) |>
  add_row_trans(
    ...
    vec_1996 = c("v_CA1996_1329", "v_CA1996_1330", "v_CA1996_1338", "v_CA1996_1339"),
  ...
  add_row_trans(
    ...
    var_short = "TKTK",
    explanation = "the percentage of people who use public transit to get to work",
    private = FALSE) |>
  add_row_trans(
    ...
    vec_2001 = NA,
    vec_1996 = NA,
    var_title = "15 minutes to work (%)",
    var_short = "TKTK",
    explanation = "the percentage of people whose commute time is less than 15 minutes",
    private = FALSE
  ) |>
  add_row_trans(
    ...
    vec_2001 = NA,
    vec_1996 = NA,
    var_title = "15-45 minutes to work (%)",
    var_short = "TKTK",
    explanation = "the percentage of people whose commute time is between 15 and 45 minutes",
    private = FALSE) |>
  add_row_trans(
    ...
    vec_2001 = NA,
    vec_1996 = NA,
    var_title = "More than 45 minutes to work (%)",
    var_short = "TKTK",
    explanation = "the percentage of people whose commute time is longer than 45 minutes",
    private = FALSE)


# Gather data -------------------------------------------------------------

data_to_add <- add_census_data(census_transport, scales, years, 
                               parent_vectors = c("trans_car_pct" = "v_CA01_1253",
                                                  "trans_car_pct" = "v_CA1996_1324",
                                                  "trans_walk_or_bike_pct" = "v_CA01_1253",
                                                  "trans_walk_or_bike_pct" = "v_CA1996_1324",
                                                  "trans_transit_pct" = "v_CA01_1253",
                                                  "trans_transit_pct" = "v_CA1996_1324"))
...
new_vars <- add_vars(data_to_add, census_transport, breaks_q3, breaks_q5)
