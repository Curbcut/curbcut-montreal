...
title_text <-
  ...
  add_row(tab = "canale", type = "main",
          text = paste0("The CanALE dataset (developed by Prof. Nancy Ross ",
                        ...
                        "transit service.")) |> 
  add_row(tab = "canale", type = "extra",
          text = paste0("<p>A safe and inviting pedestrian environment is not ",
                        ...
                        "authors: David Wachsmuth, Robin Basalaev-Binder",
                        "</i>")) |> 
