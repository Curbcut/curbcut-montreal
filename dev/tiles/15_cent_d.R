...
# Create tileset
create_tileset("cent_d-census_max_CT-auto_zoom", auto_zoom_recipe)

# Publish tileset
publish_tileset("cent_d-census_max_CT-auto_zoom")
...
centraide |> 
  select(ID) |> 
  st_set_agr("constant") |>
  upload_tile_source("cent_d-centraide",
                     access_token = .sus_token)
...
recipe_centraide <- 
  create_recipe(
    ...
    source = "mapbox://tileset-source/sus-mcgill/cent_d-centraide",
    minzoom = 3,
    maxzoom = 12, 
    simp_zoom = 12,
    layer_size = 2500,
    recipe_name = "cent_d-centraide")

# Create tileset
create_tileset("cent_d-centraide", recipe_centraide)

# Publish tileset
publish_tileset("cent_d-centraide")
...
auto_zoom_recipe <- 
  create_recipe(
    ...
    source = c(
      centraide = "mapbox://tileset-source/sus-mcgill/cent_d-centraide",
      CT = "mapbox://tileset-source/sus-mcgill/cent_d-CT"),
