  ...
  tagList(
    ...
    do.call(
      ...
      c(list(id = "sus_page", 
             ...
             tabPanel(cc_t(translation = translation, "Home"), home_UI("home"), value = "home")),
        ready_modules_ui(mods_rdy),
        list(stories_dropdown_ui(stories),
             tabPanel(cc_t(translation = translation, "Place explorer"), 
                      place_explorer_old_UI("place_explorer_old"),
                      value = "place_explorer_old"),
             tabPanel(cc_t(translation = translation, "Place explorer"), 
                      place_explorer_UI("place_explorer"),
                      value = "place_explorer"),
             navbarMenu(cc_t(translation = translation, "About"),
                        tabPanel(cc_t(translation = translation, "About Curbcut"), 
                                 about_sus_UI("about_sus"), value = "about_sus"),
                        tabPanel(cc_t(translation = translation, "How to use"), how_to_use_UI("how_to_use"), 
                                 value = "how_to_use"),
                        tabPanel(cc_t(translation = translation, "Authors"), authors_UI("authors"), value = "authors")),
             collapsible = TRUE,
             inputs = list(
               # Language toggle
               actionLink(
               ...
               materialIconButton(
                 dropdownButton(inputId = "settings",
                                a(id = "bookmark",
                                  ...
                                  role = "menuitem",
                                  href = "#",
                                  icon("link", verify_fa = FALSE), cc_t(translation = translation, "Bookmark"), 
                                  onclick = "copyUrl()"),
                                actionLink(inputId = "contact",
                                           label = cc_t(translation = translation, "Contact/feedback"),
                                           icon("comment", verify_fa = FALSE),
                                           onclick = "window.open('mailto:contact@curbcut.ca', '_blank')"),
                                actionLink(inputId = "download_data",
                                           label = cc_t(translation = translation, 
                                             "Export data"),
                                ...
                                actionLink(inputId = "subscribe",
                                           label = cc_t(translation = translation, "Newsletter"),
